...
public class NumberLinkCell : MonoBehaviour
{
    [HideInInspector]
    public int Number
    {
    ...
    private Dictionary<int, NumberLinkCell> connectedCell;
    ...
    public void Init(int row, int col, int num)
    {
        ...
        connectedCell = new Dictionary<int, NumberLinkCell>();
    ...
    public void Init()
    {
        for (int i = 0; i < 4; i++)
        {
            connectedCell[i] = NumberLinkGameManager.Instance.GetAdjacentCell(Row, Column, i);
            ...
            edgeSize *= NumberLinkGameManager.Instance.EdgeSize;
    ...
    public bool IsValidCell(NumberLinkCell cell,int direction)
    {
